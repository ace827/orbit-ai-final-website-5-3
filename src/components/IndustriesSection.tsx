      ...
      <div className="flex flex-wrap justify-center gap-3 max-w-2xl mx-auto">
        {industries.map((ind, i) => (
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-2.5 text-sm font-medium text-foreground hover:shadow-sm transition-shadow"
          >
